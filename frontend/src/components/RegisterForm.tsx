  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-glass-bg backdrop-blur-xl border border-glass-border rounded-2xl p-8 shadow-2xl">
        <h2 className="text-2xl font-bold text-white mb-1 text-center">Register</h2>
        <p className="text-slate-400 text-sm mb-8 text-center">Register to access your threat intelligence dashboard</p>

        {error && (
            <div className="bg-red-500/10 border border-red-500/50 text-red-500 text-sm p-3 rounded-lg mb-6 text-center animate-shake">
                {error}
            </div>
        )}
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button type='submit' className="w-full bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold py-3 rounded-lg transition-all shadow-lg shadow-sky-500/20 active:scale-[0.98]">
            Create Account
          </button>
        </form>
